...
import sys
sys.path.insert(0,'/home/deena/Documents/data_munge/ModaCode/') # Faraz's comment: remove this line
import moda
...
def buildTablesDMV(crash,ind,veh):
    ...
    '''
    Faraz's comment: thoughts on deleting the following commented out chunk? Otherwise it looks like work-in-progress.
    '''
    ####
    # 2 veh crashes only
    '''
    ...
    '''
    ### Faraz's comment: lots of merges and joins happening between different tables in the code below. Can you write a few lines here and talk about 
    ### what you're merging on and what the final table looks like?
	'''
...
def mergeBiss(df,bissdf):
    ...
    df = df.merge(bissdf[['CI_ID','BISS']],how='left',on='CI_ID')
     ...
     '''
    Faraz's comment: Not sure what the following commented out lines of code are doing. Perhaps, remove them?
    '''
    ...
    '''
    Faraz's comment: can you link to the source that says that b-iss over 9 is severe injuries?
    '''
...
def formatVars(df):
    ...
    '''
    FARAZ's COMMENT: is this in addition to the DMV encoding you got earlier from NHTSA? Which encoding did you end up using in the end?
    '''
...
def formatVehTypeDMV(df):
    '''VEHBDYT_ID column in df is mapped to the descriptive value given by 
        the data dictionary. A new descriptive column is added called 'DMV_VehType'.
    '''
    vehicle = {
        1 : "Police Vehicle",
        2 : "Fire Vehicle",
        ...
        22 : "Ambulance",
        23 : "Power Shovel",
        24 : "Road Building Machine",
        25 : "Road Roller",
        26 : "Road Sweeper",
        27 : "Sand Or Agricultural",
        28 : "Snow Plow",
        29 : "Snow Traveler",
        30 : "Snowmobile",
        31 : "Traction Engine",
        32 : "Tractor Crane",
        33 : "Truck Crane",
        34 : "Truck W/ Small Wheels",
        35 : "Well Driller",
        36 : "Well Servicing Rig",
        37 : "Feed Processing Machine",
        ...
        63 : "Taxi",
        66 : "Moped",
        64 : "Disabled Commercial",
        67 : "Dlr/Transporter",
        101 : "Pedestrian",
        102 : "Other Pedestrian",
        103 : "Bicyclist",
        121 : "Low Speed Vehicle",
        -2 : "Not Applicable",
        -3 : "Not Entered" }
    df['DMV_VehType'] = df.VEHBDYT_ID.map(vehicle)
    return df